...
import com.mkyong.symmetric.SymmetricKeyExample;
...
//		System.out.println("Original Message: " + msg + "\nEncrypted Message: " + encrypted_msg + "\nDecrypted Message: " + decrypted_msg);
		...
		SymmetricKeyExample symmetric = new SymmetricKeyExample("mypasswd", 32, "AES");
		symmetric.encryptFile(new File("KeyPair/text.txt"));
